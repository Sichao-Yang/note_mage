...
![iwYPmR.png](media\Chapter14_概率图模型\iwYPmR.png)

基于上述变量之间的依赖关系，我们很容易写出隐马尔可夫模型中所有变量的联合概率分布：

![iwY9X9.png](media\Chapter14_概率图模型\iwY9X9.png)

易知：**欲确定一个HMM模型需要以下三组参数**：

![iwYi01.png](media\Chapter14_概率图模型\iwYi01.png)

当确定了一个HMM模型的三个参数后，便按照下面的规则来生成观测值序列：

![iwYFTx.png](media\Chapter14_概率图模型\iwYFTx.png)

在实际应用中，HMM模型的发力点主要体现在下述三个问题上：

![iwYEtK.png](media\Chapter14_概率图模型\iwYEtK.png)
...
![iwYVfO.png](media\Chapter14_概率图模型\iwYVfO.png)

基于前向变量，很容易得到该问题的递推关系及终止条件：

![iwYAk6.png](media\Chapter14_概率图模型\iwYAk6.png)
...
![iwYepD.png](media\Chapter14_概率图模型\iwYepD.png)
...
![iwYm1e.png](media\Chapter14_概率图模型\iwYm1e.png)
...
![iwYn6H.png](media\Chapter14_概率图模型\iwYn6H.png)

![iwYdns.png](media\Chapter14_概率图模型\iwYdns.png)

【3】接着便可以对模型的三个参数进行重新估计：

![iwYY9S.png](media\Chapter14_概率图模型\iwYY9S.png)
...
![iwYGh8.png](media\Chapter14_概率图模型\iwYGh8.png)
...
![iwYUXj.png](media\Chapter14_概率图模型\iwYUXj.png)

![iwYwBn.png](media\Chapter14_概率图模型\iwYwBn.png)

### **14.4.2 信念传播**

若将变量求和操作看作是一种消息的传递过程，信念传播可以理解成：**一个节点在接收到所有其它节点的消息后才向另一个节点发送消息**，同时当前节点的边际概率正比于他所接收的消息的乘积：

![iwYDA0.png](media\Chapter14_概率图模型\iwYDA0.png)
...
![iwYgc4.png](media\Chapter14_概率图模型\iwYgc4.png)
...
![iwY2jJ.png](media\Chapter14_概率图模型\iwY2jJ.png)
...
![iwYc3F.png](media\Chapter14_概率图模型\iwYc3F.png)

![iwYWu9.png](media\Chapter14_概率图模型\iwYWu9.png)
